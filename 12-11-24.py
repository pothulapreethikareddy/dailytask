...
tr=teachingresearcher("m1","Physics")  
...
m = Manager("preethi", 25, 23000, "employee")
...
e = Employee("preethi", 30000)
d = Developer("pinky", 60000, "java")
m = Manager("Ramya", 90000, 12)
i = Intern("nani", 80000, "python", 9)
...
phone = Phone("Nokia", "123-456-7890")
...
person = Person("preethi", 25)

student = Student("Baby", 20, "A")
